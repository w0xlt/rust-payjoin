...
pub(crate) struct ValidatedOhttpKeys {
    ...
    pub(crate) transport: payjoin::OhttpTransport,
}
                ...
                match ohttp_keys {
                    Ok(keys) =>
                        return Ok(ValidatedOhttpKeys {
                            ohttp_keys: keys,
                            transport: payjoin::OhttpTransport::Relay(selected_relay),
                        }),
